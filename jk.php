	...
	<div class="limiter">
		<div class="container-login100">
            ...
            if(isset($_POST['login']))
            {
                ...
                $pass=$_POST['pass'];
                $sql="select *   from confirmed where username='$username' and pass='$pass'";
                $qwer=mysqli_query($connection,$sql);
                $row=mysqli_fetch_assoc($qwer);
                if($username==$row['username'] &&  $pass==$row['pass'])
                {?>
                    <div class="row justify-content-center">
                    <div class="card-header bg-info">
                    <h3><b>YOU ARE LOGGED IN SUCCESSFULLY</b></h3>
                    </div>
                    </div>
                    <?php
                }
                ...
                {?>
                       <div class="row justify-content-center">
                    <div class="card-header bg-info">
                    <h3><b>INCORRECT LOGIN DETAILS</b></h3>
                    </div>
                    </div> 
                <?php
