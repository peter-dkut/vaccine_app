	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form" action="y.php" method="post">

					<span class="login100-form-avatar">
						<img src="images/icons/dalian.jpeg" alt="AVATAR">
					</span>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate = "Enter surname">
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate = "Enter phone number">
						<input class="input100" type="number" name="phonenumber" maxlength="10" >
